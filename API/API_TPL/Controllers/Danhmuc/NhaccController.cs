...
namespace API_TPL.Controllers.Danhmuc
{
    ...
    public class NhaccController : ApiController
    {
        ...
        public IHttpActionResult nhacc_insert([FromBody] dynamic obj)
        {
            string query_str = "nhacc_insert";
        ...
        {
            string query_str = "nhacc_delete";

            object[] aParams = new object[1];
            try
            {
                aParams[0] = helper.BuildParameter("IDNCC", obj.IDNCC, System.Data.SqlDbType.Int);
        ...
        {
            string query_str = "nhacc_getbyid";
